...
\begin{frame}
  ...
  \begin{column}{.30\linewidth}
    % \begin{figure}
    %   \includegraphics[width=0.6\linewidth]{assets/speedup_shuffle.png}
    ...
    % \begin{figure}
    %   \includegraphics[width=0.6\linewidth]{assets/simd_shuffle.png}
    %   \caption{Diagram of Parallel Oblivious Sort on a toy example. Each color represents a thread. Colorful components are multi-threaded.}
    % \end{figure}
    % Speedup Diagrams for separtate optimizations:
